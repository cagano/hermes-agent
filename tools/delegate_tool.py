...
DELEGATE_TASK_SCHEMA = {
    ...
    "description": (
        ...
        "2. Batch (parallel): provide 'tasks' array with up to 3 items — all run concurrently.\n\n"
        "Use for: reasoning-heavy subtasks, tasks that would flood context, parallel workstreams. "
        "Use execute_code for mechanical loops; call tools directly for single calls.\n\n"
        "Subagents have NO memory of this conversation — pass context explicitly. "
